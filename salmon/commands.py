"""
Implements the Salmon command line tool's commands, which are run
by the salmon.args module dynamically.  Each command has it's
...
end in _command.  This is not required by the salmon.args module
...
def version_command():
    ...
    print "If you didn't get a copy of the LICENSE go to:\n"
    print "    https://github.com/moggers87/salmon/LICENSE"
    print ""
    print "Have fun."
